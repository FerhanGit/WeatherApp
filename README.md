...
## Web app usage
To use the app from your web browser you should open http://127.0.0.1:8080/weather
### Due to technical limitation currently is possible to display data only for Sofia.
